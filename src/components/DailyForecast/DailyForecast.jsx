...
{/* maping component start*/}
      <div className="forecast-daily" >
        <div className="forecast-daily__day">Monday</div>
        <div className="forecast-daily__temperature">
          <div className="forecast-daily__temperature-high">15 °C</div>
          <div className="forecast-daily__temperature-low">12 °C</div>
        </div>
